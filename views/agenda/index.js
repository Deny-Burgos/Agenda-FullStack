...
form.addEventListener('submit', (e) => {
  ...
  li.innerHTML = `
    <li class="flex flex-row gap-3"> 
      <input class="placeholder:text-white/30 rounded-lg p-2 bg-orange-400 focus:outline-amber-600 outline-none text-center w-1/3 md:w-1/2 sm:w-1/2" type="text" value="${contactInput.value}" readonly>
      <input class="placeholder:text-white/30 rounded-lg p-2 bg-orange-400 focus:outline-amber-600 outline-none text-center w-1/3 md:w-1/2 sm:w-1/2" type="text" value="${phoneInput.value}" readonly>
      ...
      <button class="edit-btn w-8" disabled><svg class="svg-edit" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
